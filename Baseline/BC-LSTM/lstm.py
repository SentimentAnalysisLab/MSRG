...
def unimodal(mode):
	...
	model.compile(optimizer='adadelta', loss='categorical_crossentropy',metrics=['mae', 'acc'], sample_weight_mode='temporal')
...
if __name__=="__main__":
	...
	with open('unimodal.pickle', 'rb') as handle:
	    unimodal_activations = pickle.load(handle,encoding='iso-8859-1' )

	print(unimodal_activations.keys())
